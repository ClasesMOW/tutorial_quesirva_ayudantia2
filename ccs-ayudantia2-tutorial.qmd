...
#school_data_1 <- read.csv("https://raw.githubusercontent.com/ClasesMOW/tutorial_quesirva_ayudantia2/main/data_raw/school_data_1.csv")
...
Sin embargo, si creemos que lo que también correlaciona es una inobservable como la preocupación / involucramiento de los padres aun preservan el problema de la autoselección, todavía tenemos presencia de sesgo por variables omitidad.
